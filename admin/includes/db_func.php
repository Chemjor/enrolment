<?php 
	...
	function connect_db($db = false, $server = 'localhost', $user = 'root', $pass = 'den'){
	...
	function alert_messages(){
		if(isset($_SESSION['alert'])){
			...
			$alert = explode('|', $_SESSION['alert']); //'danger|msg' arr = ['danger','msg']

			unset($_SESSION['alert']);


			return '<div class="alert alert-'.$alert[0].' alert-dismissable" style=" margin:5px 0;">
